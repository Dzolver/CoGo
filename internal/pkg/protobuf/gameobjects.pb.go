...
type User struct {
	...
	ObjectID string `protobuf:"bytes,1,opt,name=objectID,proto3" json:"objectID,omitempty"`           // @gotags: bson:"_id, omitempty"
	Uuid     string `protobuf:"bytes,2,opt,name=uuid,proto3" json:"uuid,omitempty"`                   // @gotags: bson:"uuid, omitempty"
	UserId   string `protobuf:"bytes,3,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"` // @gotags: default:"" bson:"user_id, omitempty"
	Password string `protobuf:"bytes,4,opt,name=password,proto3" json:"password,omitempty"`           // @gotags: default:"" bson:"password, omitempty"
	Active   int32  `protobuf:"varint,5,opt,name=active,proto3" json:"active,omitempty"`              // @gotags: default:"" bson:"active, omitempty"
	Logins   int32  `protobuf:"varint,6,opt,name=logins,proto3" json:"logins,omitempty"`              // @gotags: default:"" bson:"logins, omitempty"
}
...
type Profile struct {
	...
	ObjectID     string     `protobuf:"bytes,1,opt,name=objectID,proto3" json:"objectID,omitempty"`                              // @gotags: bson:"_id, omitempty"
	Uuid         string     `protobuf:"bytes,2,opt,name=uuid,proto3" json:"uuid,omitempty"`                                      // @gotags: bson:"uuid, omitempty"
	Name         string     `protobuf:"bytes,3,opt,name=name,proto3" json:"name,omitempty"`                                      // @gotags: default:"" bson:"name, omitempty"
	Level        int32      `protobuf:"varint,4,opt,name=level,proto3" json:"level,omitempty"`                                   // @gotags: default:"" bson:"level, omitempty"
	Age          int32      `protobuf:"varint,5,opt,name=age,proto3" json:"age,omitempty"`                                       // @gotags: default:"" bson:"age, omitempty"
	Title        string     `protobuf:"bytes,6,opt,name=title,proto3" json:"title,omitempty"`                                    // @gotags: default:"" bson:"title, omitempty"
	CurrentExp   float32    `protobuf:"fixed32,7,opt,name=current_exp,json=currentExp,proto3" json:"current_exp,omitempty"`      // @gotags: default:"" bson:"current_exp, omitempty"
	TotalExp     float32    `protobuf:"fixed32,8,opt,name=total_exp,json=totalExp,proto3" json:"total_exp,omitempty"`            // @gotags: default:"" bson:"total_exp, omitempty"
	MaxExp       float32    `protobuf:"fixed32,9,opt,name=max_exp,json=maxExp,proto3" json:"max_exp,omitempty"`                  // @gotags: default:"" bson:"max_exp, omitempty"
	RaceId       string     `protobuf:"bytes,10,opt,name=race_id,json=raceId,proto3" json:"race_id,omitempty"`                   // @gotags: default:"" bson:"race_id, omitempty"
	RaceName     string     `protobuf:"bytes,11,opt,name=race_name,json=raceName,proto3" json:"race_name,omitempty"`             // @gotags: default:"" bson:"race_name, omitempty"
	ClassId      string     `protobuf:"bytes,12,opt,name=class_id,json=classId,proto3" json:"class_id,omitempty"`                // @gotags: default:"" bson:"class_id, omitempty"
	ClassName    string     `protobuf:"bytes,13,opt,name=class_name,json=className,proto3" json:"class_name,omitempty"`          // @gotags: default:"" bson:"class_name, omitempty"
	LastPosition *Position  `protobuf:"bytes,14,opt,name=last_position,json=lastPosition,proto3" json:"last_position,omitempty"` // @gotags: default:"" bson:"last_position, omitempty"
	LastRegion   string     `protobuf:"bytes,15,opt,name=last_region,json=lastRegion,proto3" json:"last_region,omitempty"`       // @gotags: default:"" bson:"last_region, omitempty"
	LastLevel    string     `protobuf:"bytes,16,opt,name=last_level,json=lastLevel,proto3" json:"last_level,omitempty"`          // @gotags: default:"" bson:"last_level, omitempty"
	Items        *ItemRange `protobuf:"bytes,17,opt,name=items,proto3" json:"items,omitempty"`                                   // @gotags: default:"" bson:"items, omitempty"
	Purse        *Purse     `protobuf:"bytes,18,opt,name=purse,proto3" json:"purse,omitempty"`                                   // @gotags: default:"" bson:"purse, omitempty"
	Loadout      *Loadout   `protobuf:"bytes,19,opt,name=loadout,proto3" json:"loadout,omitempty"`                               // @gotags: default:"" bson:"loadout, omitempty"
	Stats        *Stats     `protobuf:"bytes,20,opt,name=stats,proto3" json:"stats,omitempty"`                                   // @gotags: default:"" bson:"stats, omitempty"
	BaseStats    *Stats     `protobuf:"bytes,21,opt,name=base_stats,json=baseStats,proto3" json:"base_stats,omitempty"`          // @gotags: default:"" bson:"base_stats, omitempty"
	SpellIndex   []string   `protobuf:"bytes,22,rep,name=spell_index,json=spellIndex,proto3" json:"spell_index,omitempty"`       // @gotags: default:"" bson:"spell_index, omitempty"
	Description  string     `protobuf:"bytes,23,opt,name=description,proto3" json:"description,omitempty"`                       // @gotags: default:"" bson:"description, omitempty"
}
...
type Loadout struct {
	...
	Head        string `protobuf:"bytes,1,opt,name=head,proto3" json:"head,omitempty"`                               // @gotags: bson:"head, omitempty"
	Body        string `protobuf:"bytes,2,opt,name=body,proto3" json:"body,omitempty"`                               // @gotags: bson:"body, omitempty"
	Feet        string `protobuf:"bytes,3,opt,name=feet,proto3" json:"feet,omitempty"`                               // @gotags: bson:"feet, omitempty"
	Weapon      string `protobuf:"bytes,4,opt,name=weapon,proto3" json:"weapon,omitempty"`                           // @gotags: bson:"weapon, omitempty"
	Accessory_1 string `protobuf:"bytes,5,opt,name=accessory_1,json=accessory1,proto3" json:"accessory_1,omitempty"` // @gotags: bson:"accessory_1, omitempty"
	Accessory_2 string `protobuf:"bytes,6,opt,name=accessory_2,json=accessory2,proto3" json:"accessory_2,omitempty"` // @gotags: bson:"accessory_2, omitempty"
	Accessory_3 string `protobuf:"bytes,7,opt,name=accessory_3,json=accessory3,proto3" json:"accessory_3,omitempty"` // @gotags: bson:"accessory_3, omitempty"
}
...
type Purse struct {
	...
	Bits float32 `protobuf:"fixed32,1,opt,name=bits,proto3" json:"bits,omitempty"` // @gotags: default:"0" bson:"bits, omitempty"
}
...
type Item struct {
	...
	ObjectID    string  `protobuf:"bytes,1,opt,name=objectID,proto3" json:"objectID,omitempty"`                          // @gotags: bson:"_id, omitempty"
	ItemId      string  `protobuf:"bytes,2,opt,name=item_id,json=itemId,proto3" json:"item_id,omitempty"`                // @gotags: default:"" bson:"item_id, omitempty"
	ItemType    string  `protobuf:"bytes,3,opt,name=item_type,json=itemType,proto3" json:"item_type,omitempty"`          // @gotags: default:"" bson:"item_type, omitempty"
	ItemSubtype string  `protobuf:"bytes,4,opt,name=item_subtype,json=itemSubtype,proto3" json:"item_subtype,omitempty"` // @gotags: default:"" bson:"item_subtype, omitempty"
	Entity      string  `protobuf:"bytes,5,opt,name=entity,proto3" json:"entity,omitempty"`                              // @gotags: bson:"entity, omitempty"
	Name        string  `protobuf:"bytes,6,opt,name=name,proto3" json:"name,omitempty"`                                  // @gotags: default:"" bson:"name, omitempty"
	Num         int32   `protobuf:"varint,7,opt,name=num,proto3" json:"num,omitempty"`                                   // @gotags: default:"" bson:"num, omitempty"
	Description string  `protobuf:"bytes,8,opt,name=description,proto3" json:"description,omitempty"`                    // @gotags: default:"" bson:"description, omitempty"
	Stats       *Stats  `protobuf:"bytes,9,opt,name=stats,proto3" json:"stats,omitempty"`                                // @gotags: bson:"stats, omitempty"
	BaseValue   float32 `protobuf:"fixed32,10,opt,name=base_value,json=baseValue,proto3" json:"base_value,omitempty"`    // @gotags: bson:"base_value, omitempty"
}
...
type Stats struct {
	...
	Strength     float32 `protobuf:"fixed32,1,opt,name=strength,proto3" json:"strength,omitempty"`          // @gotags: default:"0" bson:"strength, omitempty"
	Intelligence float32 `protobuf:"fixed32,2,opt,name=intelligence,proto3" json:"intelligence,omitempty"`  // @gotags: default:"0" bson:"intelligence, omitempty"
	Dexterity    float32 `protobuf:"fixed32,3,opt,name=dexterity,proto3" json:"dexterity,omitempty"`        // @gotags: default:"0" bson:"dexterity, omitempty"
	Charisma     float32 `protobuf:"fixed32,4,opt,name=charisma,proto3" json:"charisma,omitempty"`          // @gotags: default:"0" bson:"charisma, omitempty"
	Luck         float32 `protobuf:"fixed32,5,opt,name=luck,proto3" json:"luck,omitempty"`                  // @gotags: default:"0" bson:"luck, omitempty"
	Health       float32 `protobuf:"fixed32,6,opt,name=health,proto3" json:"health,omitempty"`              // @gotags: default:"0" bson:"health, omitempty"
	Mana         float32 `protobuf:"fixed32,7,opt,name=mana,proto3" json:"mana,omitempty"`                  // @gotags: default:"0" bson:"mana, omitempty"
	Attack       float32 `protobuf:"fixed32,8,opt,name=attack,proto3" json:"attack,omitempty"`              // @gotags: default:"0" bson:"attack, omitempty"
	MagicAttack  float32 `protobuf:"fixed32,9,opt,name=magicAttack,proto3" json:"magicAttack,omitempty"`    // @gotags: default:"0" bson:"magicAttack, omitempty"
	Defense      float32 `protobuf:"fixed32,10,opt,name=defense,proto3" json:"defense,omitempty"`           // @gotags: default:"0" bson:"defense, omitempty"
	MagicDefense float32 `protobuf:"fixed32,11,opt,name=magicDefense,proto3" json:"magicDefense,omitempty"` // @gotags: default:"0" bson:"magicDefense, omitempty"
	Armor        float32 `protobuf:"fixed32,12,opt,name=armor,proto3" json:"armor,omitempty"`               // @gotags: default:"0" bson:"armor, omitempty"
	Evasion      float32 `protobuf:"fixed32,13,opt,name=evasion,proto3" json:"evasion,omitempty"`           // @gotags: default:"0" bson:"evasion, omitempty"
	Accuracy     float32 `protobuf:"fixed32,14,opt,name=accuracy,proto3" json:"accuracy,omitempty"`         // @gotags: default:"0" bson:"accuracy, omitempty"
	Agility      float32 `protobuf:"fixed32,15,opt,name=agility,proto3" json:"agility,omitempty"`           // @gotags: default:"0" bson:"agility, omitempty"
	FireRes      float32 `protobuf:"fixed32,16,opt,name=fireRes,proto3" json:"fireRes,omitempty"`           // @gotags: default:"0" bson:"fireRes, omitempty"
	WaterRes     float32 `protobuf:"fixed32,17,opt,name=waterRes,proto3" json:"waterRes,omitempty"`         // @gotags: default:"0" bson:"waterRes, omitempty"
	EarthRes     float32 `protobuf:"fixed32,18,opt,name=earthRes,proto3" json:"earthRes,omitempty"`         // @gotags: default:"0" bson:"earthRes, omitempty"
	WindRes      float32 `protobuf:"fixed32,19,opt,name=windRes,proto3" json:"windRes,omitempty"`           // @gotags: default:"0" bson:"windRes, omitempty"
	IceRes       float32 `protobuf:"fixed32,20,opt,name=iceRes,proto3" json:"iceRes,omitempty"`             // @gotags: default:"0" bson:"iceRes, omitempty"
	EnergyRes    float32 `protobuf:"fixed32,21,opt,name=energyRes,proto3" json:"energyRes,omitempty"`       // @gotags: default:"0" bson:"energyRes, omitempty"
	NatureRes    float32 `protobuf:"fixed32,22,opt,name=natureRes,proto3" json:"natureRes,omitempty"`       // @gotags: default:"0" bson:"natureRes, omitempty"
	PoisonRes    float32 `protobuf:"fixed32,23,opt,name=poisonRes,proto3" json:"poisonRes,omitempty"`       // @gotags: default:"0" bson:"poisonRes, omitempty"
	MetalRes     float32 `protobuf:"fixed32,24,opt,name=metalRes,proto3" json:"metalRes,omitempty"`         // @gotags: default:"0" bson:"metalRes, omitempty"
	LightRes     float32 `protobuf:"fixed32,25,opt,name=lightRes,proto3" json:"lightRes,omitempty"`         // @gotags: default:"0" bson:"lightRes, omitempty"
	DarkRes      float32 `protobuf:"fixed32,26,opt,name=darkRes,proto3" json:"darkRes,omitempty"`           // @gotags: default:"0" bson:"darkRes, omitempty"
}
...
type ItemRange struct {
	...
	Collection []string `protobuf:"bytes,1,rep,name=collection,proto3" json:"collection,omitempty"` // @gotags: bson:"collection, omitempty"
}
...
type ShopItem struct {
	...
	Uuid     string  `protobuf:"bytes,1,opt,name=uuid,proto3" json:"uuid,omitempty"`                         // @gotags: bson:"uuid, omitempty"
	ShopItem *Item   `protobuf:"bytes,2,opt,name=shop_item,json=shopItem,proto3" json:"shop_item,omitempty"` // @gotags: bson:"shop_item, omitempty"
	Price    float32 `protobuf:"fixed32,3,opt,name=price,proto3" json:"price,omitempty"`                     // @gotags: bson:"price, omitempty"
}
...
type Spell struct {
	...
	ObjectID      string  `protobuf:"bytes,1,opt,name=objectID,proto3" json:"objectID,omitempty"`                                  // @gotags: bson:"_id, omitempty"
	SpellId       string  `protobuf:"bytes,2,opt,name=spell_id,json=spellId,proto3" json:"spell_id,omitempty"`                     // @gotags: bson:"spell_id, omitempty"
	Name          string  `protobuf:"bytes,3,opt,name=name,proto3" json:"name,omitempty"`                                          // @gotags: bson:"name, omitempty"
	ManaCost      int32   `protobuf:"varint,4,opt,name=mana_cost,json=manaCost,proto3" json:"mana_cost,omitempty"`                 // @gotags: bson:"mana_cost, omitempty"
	SpellType     string  `protobuf:"bytes,5,opt,name=spell_type,json=spellType,proto3" json:"spell_type,omitempty"`               // @gotags: bson:"spell_type, omitempty"
	Targetable    string  `protobuf:"bytes,6,opt,name=targetable,proto3" json:"targetable,omitempty"`                              // @gotags: bson:"targetable, omitempty"
	Spell         string  `protobuf:"bytes,7,opt,name=spell,proto3" json:"spell,omitempty"`                                        // @gotags: bson:"spell, omitempty"
	Damage        int32   `protobuf:"varint,8,opt,name=damage,proto3" json:"damage,omitempty"`                                     // @gotags: bson:"damage, omitempty"
	Element       string  `protobuf:"bytes,9,opt,name=element,proto3" json:"element,omitempty"`                                    // @gotags: bson:"element", omitempty"
	Level         int32   `protobuf:"varint,10,opt,name=level,proto3" json:"level,omitempty"`                                      // @gotags: bson:"level, omitempty"
	SpellDuration int32   `protobuf:"varint,11,opt,name=spell_duration,json=spellDuration,proto3" json:"spell_duration,omitempty"` // @gotags: bson:"spell_duration, omitempty"
	InitBlock     int32   `protobuf:"varint,12,opt,name=init_block,json=initBlock,proto3" json:"init_block,omitempty"`             // @gotags: bson:"init_block, omitempty"
	BlockCount    int32   `protobuf:"varint,13,opt,name=block_count,json=blockCount,proto3" json:"block_count,omitempty"`          // @gotags: bson:"block_count, omitempty"
	Effect        *Effect `protobuf:"bytes,14,opt,name=effect,proto3" json:"effect,omitempty"`                                     // @gotags: bson:"effect, omitempty"
}
...
type Effect struct {
	...
	Name           string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`                                              // @gotags: bson:"name, omitempty"
	EffectId       string `protobuf:"bytes,2,opt,name=effect_id,json=effectId,proto3" json:"effect_id,omitempty"`                      // @gotags: bson:"effect_id, omitempty"
	Element        string `protobuf:"bytes,3,opt,name=element,proto3" json:"element,omitempty"`                                        // @gotags: bson:"element, omitempty"
	EffectType     string `protobuf:"bytes,4,opt,name=effect_type,json=effectType,proto3" json:"effect_type,omitempty"`                // @gotags: bson:"effect_type, omitempty"
	BuffElement    string `protobuf:"bytes,5,opt,name=buff_element,json=buffElement,proto3" json:"buff_element,omitempty"`             // @gotags: bson:"buff_element, omitempty"
	DebuffElement  string `protobuf:"bytes,6,opt,name=debuff_element,json=debuffElement,proto3" json:"debuff_element,omitempty"`       // @gotags: bson:"debuff_element, omitempty"
	DamagePerCycle int32  `protobuf:"varint,7,opt,name=damage_per_cycle,json=damagePerCycle,proto3" json:"damage_per_cycle,omitempty"` // @gotags: bson:"damage_per_cycle, omitempty"
	Lifetime       int32  `protobuf:"varint,8,opt,name=lifetime,proto3" json:"lifetime,omitempty"`                                     // @gotags: bson:"lifetime, omitempty"
	TicksLeft      int32  `protobuf:"varint,9,opt,name=ticks_left,json=ticksLeft,proto3" json:"ticks_left,omitempty"`                  // @gotags: bson:"ticks_left, omitempty"
	Scalar         int32  `protobuf:"varint,10,opt,name=scalar,proto3" json:"scalar,omitempty"`                                        // @gotags: bson:"scalar, omitempty"
	Description    string `protobuf:"bytes,11,opt,name=description,proto3" json:"description,omitempty"`                               // @gotags: bson:"description, omitempty"
	Effector       string `protobuf:"bytes,12,opt,name=effector,proto3" json:"effector,omitempty"`                                     // @gotags: bson:"effector, omitempty"
}
...
type Client struct {
	...
	Uuid          string    `protobuf:"bytes,1,opt,name=uuid,proto3" json:"uuid,omitempty"`                                        // @gotags: bson:"uuid, omitempty"
	ConnectTime   string    `protobuf:"bytes,2,opt,name=connect_time,json=connectTime,proto3" json:"connect_time,omitempty"`       // @gotags: bson:"connect_time, omitempty"
	UdpAddr       string    `protobuf:"bytes,3,opt,name=udp_addr,json=udpAddr,proto3" json:"udp_addr,omitempty"`                   // @gotags: bson:"udp_addr, omitempty"
	BroadcastAddr string    `protobuf:"bytes,4,opt,name=broadcast_addr,json=broadcastAddr,proto3" json:"broadcast_addr,omitempty"` // @gotags: bson:"broadcast_addr, omitempty"
	Position      *Position `protobuf:"bytes,5,opt,name=position,proto3" json:"position,omitempty"`                                // @gotags: bson:"position, omitempty"
}
...
type Position struct {
	...
	PosX float32 `protobuf:"fixed32,1,opt,name=pos_x,json=posX,proto3" json:"pos_x,omitempty"` // @gotags: default="0" bson:"pos_x, omitempty"
	PosY float32 `protobuf:"fixed32,2,opt,name=pos_y,json=posY,proto3" json:"pos_y,omitempty"` // @gotags: default="1" bson:"pos_y, omitempty"
	PosZ float32 `protobuf:"fixed32,3,opt,name=pos_z,json=posZ,proto3" json:"pos_z,omitempty"` // @gotags: default="0" bson:"pos_z, omitempty"
}
...
type BattlePacket struct {
	...
	BattleId        string     `protobuf:"bytes,1,opt,name=battle_id,json=battleId,proto3" json:"battle_id,omitempty"`                       // @gotags: default:"" bson:"battle_id, omitempty"
	PlayerProfile   *Profile   `protobuf:"bytes,2,opt,name=player_profile,json=playerProfile,proto3" json:"player_profile,omitempty"`        // @gotags: default:"" bson:"player_profile, omitempty"
	Monsters        []*Monster `protobuf:"bytes,3,rep,name=monsters,proto3" json:"monsters,omitempty"`                                       // @gotags: default:"" bson:"monsters, omitempty"
	MonsterQuantity int32      `protobuf:"varint,4,opt,name=monster_quantity,json=monsterQuantity,proto3" json:"monster_quantity,omitempty"` // @gotags: default:"0" bson:"monster_quantity, omitempty"
}
...
type LoginSecretPacket struct {
	...
	UserData      *User    `protobuf:"bytes,1,opt,name=user_data,json=userData,proto3" json:"user_data,omitempty"`                // @gotags: default:"" bson:"user_data, omitempty"
	PlayerProfile *Profile `protobuf:"bytes,2,opt,name=player_profile,json=playerProfile,proto3" json:"player_profile,omitempty"` // @gotags: default:"" bson:"player_profile, omitempty"
	RegionData    *Region  `protobuf:"bytes,3,opt,name=region_data,json=regionData,proto3" json:"region_data,omitempty"`          // @gotags: default:"" bson:"region_data, omitempty"
}
...
type Region struct {
	...
	ObjectID   string   `protobuf:"bytes,1,opt,name=objectID,proto3" json:"objectID,omitempty"`                       // @gotags: bson:"_id, omitempty"
	RegionId   string   `protobuf:"bytes,2,opt,name=region_id,json=regionId,proto3" json:"region_id,omitempty"`       // @gotags: default:"" bson:"region_id, omitempty"
	RegionName string   `protobuf:"bytes,3,opt,name=region_name,json=regionName,proto3" json:"region_name,omitempty"` // @gotags: default:"" bson:"region_name, omitempty"
	Levels     []string `protobuf:"bytes,4,rep,name=levels,proto3" json:"levels,omitempty"`                           // @gotags: bson:"levels, omitempty"
}
...
type Level struct {
	...
	ObjectID  string   `protobuf:"bytes,1,opt,name=objectID,proto3" json:"objectID,omitempty"`                    // @gotags: bson:"_id, omitempty"
	LevelId   string   `protobuf:"bytes,2,opt,name=level_id,json=levelId,proto3" json:"level_id,omitempty"`       // @gotags: bson:"_id, omitempty"
	LevelName string   `protobuf:"bytes,3,opt,name=level_name,json=levelName,proto3" json:"level_name,omitempty"` // @gotags: bson:"_id, omitempty"
	Zip       string   `protobuf:"bytes,4,opt,name=zip,proto3" json:"zip,omitempty"`                              // @gotags: bson:"_id, omitempty"
	Monsters  []string `protobuf:"bytes,5,rep,name=monsters,proto3" json:"monsters,omitempty"`                    // @gotags: bson:"_id, omitempty"
	Residents []string `protobuf:"bytes,6,rep,name=residents,proto3" json:"residents,omitempty"`                  // @gotags: bson:"_id, omitempty"
}
...
type Resident struct {
	...
	ObjectID string   `protobuf:"bytes,1,opt,name=objectID,proto3" json:"objectID,omitempty"`              // @gotags: bson:"_id, omitempty"
	NpcId    string   `protobuf:"bytes,2,opt,name=npc_id,json=npcId,proto3" json:"npc_id,omitempty"`       // @gotags: default:"" bson:"npcID, omitempty"
	NpcName  string   `protobuf:"bytes,3,opt,name=npc_name,json=npcName,proto3" json:"npc_name,omitempty"` // @gotags: default:"" bson:"npcName, omitempty"
	Dialogue []string `protobuf:"bytes,4,rep,name=dialogue,proto3" json:"dialogue,omitempty"`              // @gotags: default:"" bson:dialogue, omitempty"
}
...
type ShopKeeper struct {
	...
	ObjectID  string      `protobuf:"bytes,1,opt,name=objectID,proto3" json:"objectID,omitempty"`        // @gotags: bson:"_id, omitempty"
	NpcId     string      `protobuf:"bytes,2,opt,name=npc_id,json=npcId,proto3" json:"npc_id,omitempty"` // @gotags: default:"" bson:"npcID, omitempty"
	Catalogue []*ShopItem `protobuf:"bytes,3,rep,name=catalogue,proto3" json:"catalogue,omitempty"`      // @gotags: default:"" bson:"catalogue, omitempty"
	Purse     *Purse      `protobuf:"bytes,4,opt,name=purse,proto3" json:"purse,omitempty"`              // @gotags: default:"" bson:"purse, omitempty"
}
...
type Monster struct {
	...
	ObjectID       string   `protobuf:"bytes,1,opt,name=objectID,proto3" json:"objectID,omitempty"`                                    // @gotags: bson:"_id, omitempty"
	MobId          string   `protobuf:"bytes,2,opt,name=mob_id,json=mobId,proto3" json:"mob_id,omitempty"`                             // @gotags: default:"" bson:"mobID, omitempty"
	MonsterType    string   `protobuf:"bytes,3,opt,name=monster_type,json=monsterType,proto3" json:"monster_type,omitempty"`           // @gotags: default:"" bson:"monsterType, omitempty"
	GoldGain       int32    `protobuf:"varint,4,opt,name=gold_gain,json=goldGain,proto3" json:"gold_gain,omitempty"`                   // @gotags: default:"" bson:"goldGain, omitempty"
	ExperienceGain int32    `protobuf:"varint,5,opt,name=experience_gain,json=experienceGain,proto3" json:"experience_gain,omitempty"` // @gotags: default:"" bson:"experienceGain, omitempty"
	Profile        *Profile `protobuf:"bytes,6,opt,name=profile,proto3" json:"profile,omitempty"`                                      // @gotags: default:"" bson:"mobVitals, omitempty"
	Stats          *Stats   `protobuf:"bytes,7,opt,name=stats,proto3" json:"stats,omitempty"`                                          // @gotags: default:"" bson:"stats, omitempty"
	Actions        []*Spell `protobuf:"bytes,8,rep,name=actions,proto3" json:"actions,omitempty"`                                      // @gotags: default:"" bson:"attackActions, omitempty"
	Element        string   `protobuf:"bytes,9,opt,name=element,proto3" json:"element,omitempty"`                                      // @gotags: default:"" bson:"element, omitempty"
	Regions        []string `protobuf:"bytes,10,rep,name=regions,proto3" json:"regions,omitempty"`                                     // @gotags: bson:"regions, omitempty"
}
...
type RegionData struct {
	...
	Region    *Region    `protobuf:"bytes,1,opt,name=region,proto3" json:"region,omitempty"`                        // @gotags: default:"" bson:"region, omitempty"
	LevelData *LevelData `protobuf:"bytes,2,opt,name=level_data,json=levelData,proto3" json:"level_data,omitempty"` // @gotags: default:"" bson:"level, omitempty"
}
...
type LevelData struct {
	...
	Level     *Level      `protobuf:"bytes,1,opt,name=level,proto3" json:"level,omitempty"`         // @gotags: default:"" bson:"level, omitempty"
	Residents []*Resident `protobuf:"bytes,2,rep,name=residents,proto3" json:"residents,omitempty"` // @gotags: default:"" bson:"residents", omitempty"
}
...
type Sessions struct {
	...
	BattleSessions map[string]*BattleSession `protobuf:"bytes,1,rep,name=battle_sessions,json=battleSessions,proto3" json:"battle_sessions,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // @gotags: default:"" bson:"battle_sessions, omitempty"
}
...
type BattleSession struct {
	...
	BattleId     string     `protobuf:"bytes,1,opt,name=battle_id,json=battleId,proto3" json:"battle_id,omitempty"`                     // @gotags: default:"" bson:"battle_id, omitempty"
	Status       int32      `protobuf:"varint,2,opt,name=status,proto3" json:"status,omitempty"`                                        // @gotags: default:"0" bson:"status, omitempty"
	Monsters     []*Monster `protobuf:"bytes,3,rep,name=monsters,proto3" json:"monsters,omitempty"`                                     // @gotags: default:"" bson:"monsters, omitempty"
	RewardMatrix []int32    `protobuf:"varint,4,rep,packed,name=reward_matrix,json=rewardMatrix,proto3" json:"reward_matrix,omitempty"` // @gotags: default:"" bson:"reward_matrix, omitempty"
	Reward       *Reward    `protobuf:"bytes,5,opt,name=reward,proto3" json:"reward,omitempty"`                                         // @gotags: default:"" bson:"reward, omitempty"
}
...
type Reward struct {
	...
	Gold     float32 `protobuf:"fixed32,1,opt,name=gold,proto3" json:"gold,omitempty"`                         // @gotags: default:"0" bson:"gold, omitempty"
	Exp      float32 `protobuf:"fixed32,2,opt,name=exp,proto3" json:"exp,omitempty"`                           // @gotags: default:"0" bson:"exp, omitempty"
	TotalExp float32 `protobuf:"fixed32,3,opt,name=total_exp,json=totalExp,proto3" json:"total_exp,omitempty"` // @gotags: default:"0" bson:"total_exp, omitempty"
}
...
type Packet struct {
	...
	Uuid        string `protobuf:"bytes,1,opt,name=uuid,proto3" json:"uuid,omitempty"`                                  // @gotags: default:"" bson:"packet_id, omitempty"
	PacketCode  string `protobuf:"bytes,2,opt,name=packet_code,json=packetCode,proto3" json:"packet_code,omitempty"`    // @gotags: default:"" bson:"packet_code, omitempty"
	Chain       bool   `protobuf:"varint,3,opt,name=chain,proto3" json:"chain,omitempty"`                               // @gotags: default:"" bson:"chain, omitempty"
	ServiceType string `protobuf:"bytes,4,opt,name=service_type,json=serviceType,proto3" json:"service_type,omitempty"` // @gotags: default:"" bson:"service_type, omitempty"
	Content     string `protobuf:"bytes,5,opt,name=content,proto3" json:"content,omitempty"`                            // @gotags: default:"" bson:"content, omitempty"
}
...
type PlayerPacketCache struct {
	...
	PacketCache map[string]*Packet `protobuf:"bytes,1,rep,name=packet_cache,json=packetCache,proto3" json:"packet_cache,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // @gotags: default:"" bson:"packet_cache, omitempty"
}
...
var file_gameobjects_proto_rawDesc = []byte{
	...
	0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x42, 0x17, 0x5a, 0x15, 0x69, 0x6e, 0x74, 0x65, 0x72,
	0x6e, 0x61, 0x6c, 0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66,
